...
Pod::Spec.new do |s|
  s.name             = 'WTYCommon'
  s.version          = '0.1.0'
  s.summary          = 'A short description of WTYCommon.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/wang.tianyou/WTYCommon'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'wang.tianyou' => 'wangtianyouchina@163.com' }
  s.source           = { :git => 'https://github.com/wang.tianyou/WTYCommon.git', :tag => s.version.to_s }
